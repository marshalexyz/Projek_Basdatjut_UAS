          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-5">
                         <p>Kinclongkan kendaraan anda bersama Hago Car Wash</p>
                    </div>

                    <div class="col-md-8 col-sm-7 text-align-right">
                         <span class="phone-icon"><i class="fa fa-phone"></i>085162761186</span>
     ...
     <section class="navbar navbar-default navbar-static-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="index.html" class="navbar-brand"><i class="fa fa-h-square"></i>ago - Car Wash</a>
               </div>
                    ...
                    <div class="col-md-6 col-sm-6">
                         <div class="about-info">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   <p>Hago Carwash merupakan salah satu bidang usaha yang menawarkan jasa perawatan kendaraan berupa pencucian dan pembersihan kendaraan.</p>
                              </div>
...
?>
     ...
     <div class="footer-thumb">
          ...
          <div class="contact-info">
               <p><i class="fa fa-phone"></i> <a href="https://api.whatsapp.com/send?phone=6285162761186">085162761186</a></p>
               <p><i class="fa fa-envelope-o"></i> <a href="mailto:hago_caswash@company.com">hago_caswash@company.com</a></p>
          </div>
     </div>
</div>
